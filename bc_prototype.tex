...
The Quasigroup With Holes (QWH) is former fully filled quasigroup where were $p\%$ 
...
Quasigroup Completion Problem (QCP) consists of empty table where are then filled
