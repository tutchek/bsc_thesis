...
My thanks also belongs to V. Kopal who helped me with correction of the English text.
...
\noindent Prohla¹uji, ¾e jsem svou bakaláøskou práci napsal(a) samostatnì a 
...
\noindent Abstract: Constraint solver is specialized software used to solve 
...
\include{chapters/chapter3} % benchmarks

\include{chapters/chapter2} % solvers
