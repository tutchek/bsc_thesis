...
Further examples of CSP can be found in \cite{csplib} or \cite{Apt2003}
...
Linux 32bit/64bit and SunOS Sparc platforms. The system is based on the Prolog programming
language which is extended bz new predicates and operators. Prolog extensions are 
more described in "Modelling Capabilities" subsection. ECLiPSe provides grafical interface,
...
on the n $\times$ n chessboard so that none of them can hit any other. 
