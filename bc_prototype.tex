...
\bigskip
\noindent In Prague, 6$^{\mathrm{th}}$ August 2009 \hspace{\fill}Michal Tuláèek\\ % doplòte patøièné datum, jméno a pøíjmení
...
a vybrané z nich testuje z pohledu u¾ivatelské pøístupnosti a rozsahu problémù,
které lze modelovat. \\
