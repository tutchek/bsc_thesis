...
model problem containing integers, boolean variables and finite integer set. Gecode
is a free open source software as most of the mentioned solvers are. The librarz is
distributed as source codes and Windows OS there is also an installer with
pre-compiled libraries. Optionaly user needs a Qt library, which is used in 
a visualise graphic tool Gist. Apart from basic constraints, Gecode has also 
...
helps to ease a work with expressions. A disadvantage is a lack of explicit consciousness
