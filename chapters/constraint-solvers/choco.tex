...
at Ecole des Mines de Nantes in France and it is freely available for downloading from 
...
The implementation of the benchmarks in the Choco solver can be found in the section
\ref{implementation:choco}. All benchmarks have the similar structure. First we define
an object of type CPModel which represents the model. We did not have to use a different models
of the problems than the models proposed in the chapter \ref{benchmarks}. The set of constraints available
in the solver was sufficient to represent the problems. 
